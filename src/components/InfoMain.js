...
export class InfoMain extends Component {
  render() {
    return (
      <main>
            ...
            <div class="carousel-item active">
              ...
              <div class="container">
                <div class="carousel-caption text-start">
                  ...
                  <p>
                    <a
                      class="btn btn-lg btn-primary createAccountBtn"
                      href="#"
            ...
            <div class="carousel-item">
              ...
              <div class="container">
                <div class="carousel-caption">
                  ...
                  <p>
                    <a
                      class="btn btn-lg btn-primary dashboardBtns"
                      href="app-dashboard/dashboard.html"
                      role="button"
                    >
                      Open SII
                    </a>
            ...
            <div class="carousel-item">
              ...
              <div class="container">
                <div class="carousel-caption text-end">
                  ...
                  <p>
                    <a
                      class="btn btn-lg btn-primary loginBtn"
                      href="#"
                      role="button"
                    >
                      Log in
